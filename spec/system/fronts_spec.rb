...
RSpec.describe "Fronts", type: :system do
  describe '先攻試合情報登録' do
  ...
  describe '後攻試合情報登録' do
    ...
    it 'スターティングメンバー登録' do
      ...
      # 先攻試合ページに移動する
      click_on(@match.match_name)
      expect(page).to have_content('後攻で試合')
      # 先攻で試合画面へ遷移
      click_on('後攻で試合')
      # フォーム情報を入力
      fill_in "backs-first-fa-score-field", with: @back.back_first_fa_inning
      fill_in "backs-second-fa-score-field", with: @back.back_second_fa_inning
      fill_in "backs-third-fa-score-field", with: @back.back_third_fa_inning
      fill_in "backs-fourth-fa-score-field", with: @back.back_fourth_fa_inning
      fill_in "backs-fifth-fa-score-field", with: @back.back_fifth_fa_inning
      fill_in "backs-sixth-fa-score-field", with: @back.back_sixth_fa_inning
      fill_in "backs-seventh-fa-score-field", with: @back.back_seventh_fa_inning
      fill_in "backs-eighth-fa-score-field", with: @back.back_eighth_fa_inning
      fill_in "backs-ninth-fa-score-field", with: @back.back_ninth_fa_inning
      fill_in "backs-first-sa-score-field", with: @back.back_first_sa_inning
      fill_in "backs-second-sa-score-field", with: @back.back_second_sa_inning
      fill_in "backs-third-sa-score-field", with: @back.back_third_sa_inning
      fill_in "backs-fourth-sa-score-field", with: @back.back_fourth_sa_inning
      fill_in "backs-fifth-sa-score-field", with: @back.back_fifth_sa_inning
      fill_in "backs-sixth-sa-score-field", with: @back.back_sixth_sa_inning
      fill_in "backs-seventh-sa-score-field", with: @back.back_seventh_sa_inning
      fill_in "backs-eighth-sa-score-field", with: @back.back_eighth_sa_inning
      fill_in "backs-ninth-sa-score-field", with: @back.back_ninth_sa_inning
      # 保存するとFrontモデルのカウントが１上がることを確認する
      expect{
      find('input[name="commit"]').click
      }.to change { Back.count }.by(1)
      # 保存完了するとトップページに遷移することを確認する
      expect(current_path).to eq root_path
      # 「試合結果を保存しました。」の文字があることを確認する
      expect(page).to have_content("試合結果を保存しました。")
