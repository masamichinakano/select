...
window.addEventListener("load", function() {
  var sa_score = document.getElementById("backs-first-sa-score-field");
  sa_score.addEventListener("input", function() {
    var sa_first_fa_score = parseInt(sa_score.value);
    var sa_total = document.getElementById("backs-sa-total");

    sa_total.innerHTML = sa_first_fa_score;
  })  
  // 二回裏
  var sa_second_score = document.getElementById("backs-second-sa-score-field");
  ...
  // 三回裏
  var sa_third_score = document.getElementById("backs-third-sa-score-field");
  ...
  // 四回裏
  var sa_fourth_score = document.getElementById("backs-fourth-sa-score-field");
  ...
  // 五回裏
  var sa_fifth_score = document.getElementById("backs-fifth-sa-score-field");
  ...
  // 六回裏
  var sa_sixth_score = document.getElementById("backs-sixth-sa-score-field");
  ...
  // 七回裏
  var sa_seventh_score = document.getElementById("backs-seventh-sa-score-field");
  ...
  // 八回裏
  var sa_eighth_score = document.getElementById("backs-eighth-sa-score-field");
  ...
  // 九回裏
  var sa_ninth_score = document.getElementById("backs-ninth-sa-score-field");
