...
window.addEventListener("load", function() {
  var score = document.getElementById("backs-first-fa-score-field");
  score.addEventListener("input", function() {
    var first_fa_score = parseInt(score.value);
    var fa_total = document.getElementById("backs-fa-total");

    fa_total.innerHTML = first_fa_score;
  })  
  // 二回表
  var second_score = document.getElementById("backs-second-fa-score-field");
  ...
  // 三回表
  var third_score = document.getElementById("backs-third-fa-score-field");
  ...
  // 四回表
  var fourth_score = document.getElementById("backs-fourth-fa-score-field");
  ...
  // 五回表
  var fifth_score = document.getElementById("backs-fifth-fa-score-field");
  ...
  // 六回表
  var sixth_score = document.getElementById("backs-sixth-fa-score-field");
  ...
  // 七回表
  var seventh_score = document.getElementById("backs-seventh-fa-score-field");
  ...
  // 八回表
  var eighth_score = document.getElementById("backs-eighth-fa-score-field");
  ...
  // 八回表
  var ninth_score = document.getElementById("backs-ninth-fa-score-field");
